...
*/
public class Flaaffy extends Pokemon implements ElectricType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 145;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 34;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 140;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 180;
   /** The species default height in meters. */
   static final double SPECIES_HT = 0.8;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 13.3;
   /** Species name. **/
   static final String SPECIES_NAME = "Flaaffy";
   ...
   */
   protected Flaaffy(String species, String name, int num, double ht, 
