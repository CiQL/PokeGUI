...
*/
public class Fearow extends Pokemon implements NormalType, FlyingType {
   ...
   static final int POKEDEX_NUM = 22;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Fearow";
   ...
   */
   protected Fearow(String species, String name, int num, double ht, 
