...
*/
public class Pupitar extends Pokemon implements RockType, GroundType {
   ...
   static final int POKEDEX_NUM = 247;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Pupitar";
   ...
   */
   protected Pupitar(String species, String name, int num, double ht, 
