...
*/
public class Chinchou extends Pokemon implements WaterType, ElectricType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 106;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 32;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 150;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 170;
   /** The species default height in meters. */
   static final double SPECIES_HT = 0.5;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 12.0;
   /** Species name. **/
   static final String SPECIES_NAME = "Chinchou";
   ...
   */
   protected Chinchou(String species, String name, int num, double ht, 
                     double wt, int baseAttackPwr, int baseDefensePwr, 
                     int baseStaminaPwr) {
      super(species, name, num, WATER_COLOR, ht, wt, WATER_TYPE, 
      ELECTRIC_TYPE, baseAttackPwr, baseDefensePwr, baseStaminaPwr);
   ...
   */
   protected void chooseFastAttack() {
      chooseFastAttack(WATER_FAST_ATTACKS, WATER_FAST_ATK_POWER,
                       ELECTRIC_FAST_ATTACKS, ELECTRIC_FAST_ATK_POWER);
   }
   /** Fast attack chooser.
   ...
   */
   protected void chooseSpecialAttack() {
      chooseSpecialAttack(WATER_SPECIAL_ATTACKS, WATER_SPECIAL_ATK_POWER,
                          ELECTRIC_SPECIAL_ATTACKS, ELECTRIC_SPECIAL_ATK_POWER);
   }
   /** Special attack chooser.
   * Randomly picks an attack from given type attack arrays.
   * @param type1Attacks String array of attack names for type 1
