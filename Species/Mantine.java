...
*/
public class Mantine extends Pokemon implements WaterType, FlyingType {
   ...
   static final int POKEDEX_NUM = 226;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Mantine";
   ...
   */
   protected Mantine(String species, String name, int num, double ht, 
