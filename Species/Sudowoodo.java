...
/**
* Sudowoodo Pokémon object class.
* 
...
*/
public class Sudowoodo extends Pokemon implements RockType, NoneType {
   ...
   static final int POKEDEX_NUM = 185;
   /** The species default height in meters. */
   static final double SPECIES_HT = 1.2;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 38.0;
   /** Species name. **/
   static final String SPECIES_NAME = "Sudowoodo";
   ...
   */
   protected Sudowoodo(String species, String name, int num, double ht, 
