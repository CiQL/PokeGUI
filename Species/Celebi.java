...
*/
public class Celebi extends Pokemon implements PsychicType, GrassType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 210;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 63;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 200;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 251;
   /** The species default height in meters. */
   static final double SPECIES_HT = 0.6;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 5.0;
   /** Species name. **/
   static final String SPECIES_NAME = "Celebi";
   ...
   */
   protected Celebi(String species, String name, int num, double ht, 
