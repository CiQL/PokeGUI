...
/**
* Wigglytuff Pokémon object class.
* 
...
*/
public class Wigglytuff extends Pokemon implements NormalType, FairyType {
   ...
   static final int BASE_STAMINA_POWER = 280;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 40;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Wigglytuff";
   ...
   */
   protected Wigglytuff(String species, String name, int num, double ht, 
