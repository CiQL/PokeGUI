...
/**
* Kangaskhan Pokémon object class.
* 
...
*/
public class Kangaskhan extends Pokemon implements NormalType, NoneType {
   ...
   static final int POKEDEX_NUM = 115;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Kangaskhan";
   ...
   */
   protected Kangaskhan(String species, String name, int num, double ht, 
