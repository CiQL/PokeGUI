...
*/
public class Shuckle extends Pokemon implements BugType, RockType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 17;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 119;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 40;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 213;
   /** The species default height in meters. */
   static final double SPECIES_HT = 0.6;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 20.5;
   /** Species name. **/
   static final String SPECIES_NAME = "Shuckle";
   ...
   */
   protected Shuckle(String species, String name, int num, double ht, 
