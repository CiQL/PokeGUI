...
/**
* Butterfree Pokémon object class.
* 
...
*/
public class Butterfree extends Pokemon implements BugType, FlyingType {
   ...
   static final int POKEDEX_NUM = 12;
   /** The species default height in meters. */
   static final double SPECIES_HT = 1.1;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 32.0;
   /** Species name. **/
   static final String SPECIES_NAME = "Butterfree";
   ...
   */
   protected Butterfree(String species, String name, int num, double ht, 
