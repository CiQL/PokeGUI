...
*/
public class Jumpluff extends Pokemon implements GrassType, FlyingType {
   ...
   static final int POKEDEX_NUM = 189;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Jumpluff";
   ...
   */
   protected Jumpluff(String species, String name, int num, double ht, 
