...
/**
* Sandslash Pokémon object class.
* 
...
*/
public class Sandslash extends Pokemon implements GroundType, NoneType {
   ...
   static final int POKEDEX_NUM = 28;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Sandslash";
   ...
   */
   protected Sandslash(String species, String name, int num, double ht, 
