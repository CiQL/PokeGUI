...
/**
* Tyranitar Pokémon object class.
* 
...
*/
public class Tyranitar extends Pokemon implements RockType, DarkType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 251;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 64;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 200;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 248;
   /** The species default height in meters. */
   static final double SPECIES_HT = 2.0;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 202.0;
   /** Species name. **/
   static final String SPECIES_NAME = "Tyranitar";
   ...
   */
   protected Tyranitar(String species, String name, int num, double ht, 
                     double wt, int baseAttackPwr, int baseDefensePwr, 
                     int baseStaminaPwr) {
      super(species, name, num, ROCK_COLOR, ht, wt, ROCK_TYPE, 
      DARK_TYPE, baseAttackPwr, baseDefensePwr, baseStaminaPwr);
   ...
   */
   protected void chooseFastAttack() {
      chooseFastAttack(ROCK_FAST_ATTACKS, ROCK_FAST_ATK_POWER,
                       DARK_FAST_ATTACKS, DARK_FAST_ATK_POWER);
   }
   /** Fast attack chooser.
   ...
   */
   protected void chooseSpecialAttack() {
      chooseSpecialAttack(ROCK_SPECIAL_ATTACKS, ROCK_SPECIAL_ATK_POWER,
                          DARK_SPECIAL_ATTACKS, DARK_SPECIAL_ATK_POWER);
   }
   /** Special attack chooser.
   * Randomly picks an attack from given type attack arrays.
   * @param type1Attacks String array of attack names for type 1
