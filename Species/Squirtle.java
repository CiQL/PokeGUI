...
*/
public class Squirtle extends Pokemon implements WaterType, NoneType {
   ...
   static final int POKEDEX_NUM = 7;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Squirtle";
