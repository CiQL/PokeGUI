...
import Species.Types.DragonType;
import Species.Types.FlyingType;
/**
* Dragonite Pokémon object class.
* 
...
*/
public class Dragonite extends Pokemon implements DragonType, FlyingType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 263;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 60;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 182;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 149;
   /** The species default height in meters. */
   static final double SPECIES_HT = 2.2;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 210.0;
   /** Species name. **/
   static final String SPECIES_NAME = "Dragonite";
   ...
   */
   protected Dragonite(String species, String name, int num, double ht, 
                     double wt, int baseAttackPwr, int baseDefensePwr, 
                     int baseStaminaPwr) {
      super(species, name, num, DRAGON_COLOR, ht, wt, DRAGON_TYPE, 
   ...
   */
   protected void chooseFastAttack() {
      chooseFastAttack(DRAGON_FAST_ATTACKS, DRAGON_FAST_ATK_POWER,
   ...
   */
   protected void chooseSpecialAttack() {
      chooseSpecialAttack(DRAGON_SPECIAL_ATTACKS, DRAGON_SPECIAL_ATK_POWER,
