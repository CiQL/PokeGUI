...
*/
public class Swinub extends Pokemon implements IceType, GroundType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 90;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 22;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 100;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 220;
   /** The species default height in meters. */
   static final double SPECIES_HT = 0.4;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 6.5;
   /** Species name. **/
   static final String SPECIES_NAME = "Swinub";
   ...
   */
   protected Swinub(String species, String name, int num, double ht, 
