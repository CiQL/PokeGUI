...
*/
public class Kabutops extends Pokemon implements RockType, WaterType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 220;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 61;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 120;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 141;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Kabutops";
   ...
   */
   protected Kabutops(String species, String name, int num, double ht, 
