...
/**
* Exeggutor Pokémon object class.
* 
...
*/
public class Exeggutor extends Pokemon implements GrassType, PsychicType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 233;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 47;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 190;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 103;
   /** The species default height in meters. */
   static final double SPECIES_HT = 2.0;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 120.0;
   /** Species name. **/
   static final String SPECIES_NAME = "Exeggutor";
   ...
   */
   protected Exeggutor(String species, String name, int num, double ht, 
   ...
   */
   protected void chooseFastAttack() {
      chooseFastAttack(GRASS_FAST_ATTACKS, GRASS_FAST_ATK_POWER,
   ...
   */
   protected void chooseSpecialAttack() {
      chooseSpecialAttack(GRASS_SPECIAL_ATTACKS, GRASS_SPECIAL_ATK_POWER,
