...
*/
public class Kingler extends Pokemon implements WaterType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 240;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 64;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 110;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 99;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Kingler";
   ...
   */
   protected Kingler(String species, String name, int num, double ht, 
