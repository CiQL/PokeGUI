...
*/
public class Golbat extends Pokemon implements PoisonType, FlyingType {
   ...
   static final int POKEDEX_NUM = 42;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Golbat";
   ...
   */
   protected Golbat(String species, String name, int num, double ht, 
