...
public class Ampharos extends Pokemon implements ElectricType, NoneType {
   ...
   */
   protected Ampharos(String species, String name, int num, double ht, 
