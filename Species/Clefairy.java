...
*/
public class Clefairy extends Pokemon implements FairyType, NoneType {
   ...
   static final int BASE_STAMINA_POWER = 140;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 35;
   /** The species default height in meters. */
   static final double SPECIES_HT = 0.6;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 7.5;
   /** Species name. **/
   static final String SPECIES_NAME = "Clefairy";
   ...
   */
   protected Clefairy(String species, String name, int num, double ht, 
                     double wt, int baseAttackPwr, int baseDefensePwr, 
                     int baseStaminaPwr) {
      super(species, name, num, FAIRY_COLOR, ht, wt, FAIRY_TYPE, 
   ...
   */
   protected void chooseFastAttack() {
      chooseFastAttack(FAIRY_FAST_ATTACKS, FAIRY_FAST_ATK_POWER,
   ...
   */
   protected void chooseSpecialAttack() {
      chooseSpecialAttack(FAIRY_SPECIAL_ATTACKS, FAIRY_SPECIAL_ATK_POWER,
