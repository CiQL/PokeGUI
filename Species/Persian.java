...
*/
public class Persian extends Pokemon implements NormalType, NoneType {
   ...
   static final int POKEDEX_NUM = 53;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Persian";
   ...
   */
   protected Persian(String species, String name, int num, double ht, 
