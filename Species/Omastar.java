...
*/
public class Omastar extends Pokemon implements RockType, WaterType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 207;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 68;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 140;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 139;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Omastar";
   ...
   */
   protected Omastar(String species, String name, int num, double ht, 
