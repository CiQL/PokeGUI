...
public class Zapdos extends Pokemon implements ElectricType, FlyingType {
   ...
   */
   protected Zapdos(String species, String name, int num, double ht, 
