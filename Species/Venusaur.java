...
*/
public class Venusaur extends Pokemon implements GrassType, PoisonType {
   ...
   */
   protected Venusaur(String species, String name, int num, double ht, 
