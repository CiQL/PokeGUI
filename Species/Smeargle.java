...
public class Smeargle extends Pokemon implements NormalType, NoneType {
   ...
   */
   protected Smeargle(String species, String name, int num, double ht, 
