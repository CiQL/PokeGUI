...
/**
* Tentacool Pokémon object class.
* 
...
public class Tentacool extends Pokemon implements WaterType, PoisonType {
   ...
   */
   protected Tentacool(String species, String name, int num, double ht, 
