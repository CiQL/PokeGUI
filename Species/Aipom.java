...
*/
public class Aipom extends Pokemon implements NormalType, NoneType {
   ...
   static final int POKEDEX_NUM = 190;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Aipom";
   ...
   */
   protected Aipom(String species, String name, int num, double ht, 
