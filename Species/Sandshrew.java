...
/**
* Sandshrew Pokémon object class.
* 
...
*/
public class Sandshrew extends Pokemon implements GroundType, NoneType {
   ...
   static final int POKEDEX_NUM = 27;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Sandshrew";
   ...
   */
   protected Sandshrew(String species, String name, int num, double ht, 
