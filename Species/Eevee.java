...
*/
public class Eevee extends Pokemon implements NormalType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 104;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 36;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 110;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 133;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Eevee";
   ...
   */
   protected Eevee(String species, String name, int num, double ht, 
