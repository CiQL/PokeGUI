...
*/
public class HoOh extends Pokemon implements FireType, FlyingType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 239;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 82;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 193;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 250;
   /** The species default height in meters. */
   static final double SPECIES_HT = 3.8;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 199.0;
   /** Species name. **/
   static final String SPECIES_NAME = "Ho-Oh";
   ...
   */
   protected HoOh(String species, String name, int num, double ht, 
