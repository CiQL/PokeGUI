...
*/
public class Unown extends Pokemon implements PsychicType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 136;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 27;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 96;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 201;
   /** The species default height in meters. */
   static final double SPECIES_HT = 0.5;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 5.0;
   /** Species name. **/
   static final String SPECIES_NAME = "Unown";
   ...
   */
   protected Unown(String species, String name, int num, double ht, 
