...
*/
public class Geodude extends Pokemon implements RockType, GroundType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 132;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 49;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 80;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 74;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Geodude";
   ...
   */
   protected Geodude(String species, String name, int num, double ht, 
