...
*/
public class Lanturn extends Pokemon implements WaterType, ElectricType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 146;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 44;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 250;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 171;
   /** The species default height in meters. */
   static final double SPECIES_HT = 1.2;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 22.5;
   /** Species name. **/
   static final String SPECIES_NAME = "Lanturn";
   ...
   */
   protected Lanturn(String species, String name, int num, double ht, 
