...
*/
public class Pidgey extends Pokemon implements NormalType, FlyingType {
   ...
   static final int POKEDEX_NUM = 16;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Pidgey";
   ...
   */
   protected Pidgey(String species, String name, int num, double ht, 
