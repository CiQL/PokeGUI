...
*/
public class Kakuna extends Pokemon implements BugType, PoisonType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 46;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 26;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 90;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 14;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Kakuna";
   ...
   */
   protected Kakuna(String species, String name, int num, double ht, 
