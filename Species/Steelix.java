...
*/
public class Steelix extends Pokemon implements SteelType, GroundType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 148;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 100;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 150;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 208;
   /** The species default height in meters. */
   static final double SPECIES_HT = 9.2;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 400.0;
   /** Species name. **/
   static final String SPECIES_NAME = "Steelix";
   ...
   */
   protected Steelix(String species, String name, int num, double ht, 
