...
*/
public class Slugma extends Pokemon implements FireType, NoneType {
   ...
   static final int POKEDEX_NUM = 218;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Slugma";
   ...
   */
   protected Slugma(String species, String name, int num, double ht, 
