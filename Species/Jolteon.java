...
*/
public class Jolteon extends Pokemon implements ElectricType, NoneType {
   ...
   */
   protected Jolteon(String species, String name, int num, double ht, 
