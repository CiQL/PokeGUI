...
/**
* Tentacruel Pokémon object class.
* 
...
*/
public class Tentacruel extends Pokemon implements WaterType, PoisonType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 166;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 71;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 160;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 73;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Tentacruel";
   ...
   */
   protected Tentacruel(String species, String name, int num, double ht, 
