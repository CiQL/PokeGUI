...
/**
* Piloswine Pokémon object class.
* 
...
public class Piloswine extends Pokemon implements IceType, GroundType {
   ...
   */
   protected Piloswine(String species, String name, int num, double ht, 
