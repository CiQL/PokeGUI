...
*/
public class Scizor extends Pokemon implements BugType, SteelType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 236;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 57;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 140;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 212;
   /** The species default height in meters. */
   static final double SPECIES_HT = 1.8;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 118.0;
   /** Species name. **/
   static final String SPECIES_NAME = "Scizor";
   ...
   */
   protected Scizor(String species, String name, int num, double ht, 
