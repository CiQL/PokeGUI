...
*/
public class Skiploom extends Pokemon implements GrassType, FlyingType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 91;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 38;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 110;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 188;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Skiploom";
   ...
   */
   protected Skiploom(String species, String name, int num, double ht, 
