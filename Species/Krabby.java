...
*/
public class Krabby extends Pokemon implements WaterType, NoneType {
   ...
   static final int POKEDEX_NUM = 98;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Krabby";
   ...
   */
   protected Krabby(String species, String name, int num, double ht, 
