...
*/
public class Hypno extends Pokemon implements PsychicType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 144;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 65;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 170;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 97;
   /** The species default height in meters. */
   static final double SPECIES_HT = 1.6;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 75.6;
   /** Species name. **/
   static final String SPECIES_NAME = "Hypno";
   ...
   */
   protected Hypno(String species, String name, int num, double ht, 
