...
*/
public class Omanyte extends Pokemon implements RockType, WaterType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 155;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 52;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 70;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 138;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Omanyte";
   ...
   */
   protected Omanyte(String species, String name, int num, double ht, 
