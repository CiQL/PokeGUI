...
*/
public class Delibird extends Pokemon implements IceType, FlyingType {
   ...
   */
   protected Delibird(String species, String name, int num, double ht, 
