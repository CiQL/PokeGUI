...
/**
* Exeggcute Pokémon object class.
* 
...
*/
public class Exeggcute extends Pokemon implements GrassType, PsychicType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 107;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 42;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 120;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 102;
   /** The species default height in meters. */
   static final double SPECIES_HT = 0.4;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 2.5;
   /** Species name. **/
   static final String SPECIES_NAME = "Exeggcute";
   ...
   */
   protected Exeggcute(String species, String name, int num, double ht, 
