...
*/
public class Furret extends Pokemon implements NormalType, NoneType {
   ...
   static final int POKEDEX_NUM = 162;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Furret";
   ...
   */
   protected Furret(String species, String name, int num, double ht, 
