...
/**
* Aerodactyl Pokémon object class.
* 
...
public class Aerodactyl extends Pokemon implements RockType, FlyingType {
   ...
   */
   protected Aerodactyl(String species, String name, int num, double ht, 
