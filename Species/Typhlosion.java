...
/**
* Typhlosion Pokémon object class.
* 
...
*/
public class Typhlosion extends Pokemon implements FireType, NoneType {
   ...
   static final int POKEDEX_NUM = 157;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Typhlosion";
   ...
   */
   protected Typhlosion(String species, String name, int num, double ht, 
