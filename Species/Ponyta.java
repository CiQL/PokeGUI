...
*/
public class Ponyta extends Pokemon implements FireType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 170;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 40;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 100;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 77;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Ponyta";
   ...
   */
   protected Ponyta(String species, String name, int num, double ht, 
