...
*/
public class Quilava extends Pokemon implements FireType, NoneType {
   ...
   static final int POKEDEX_NUM = 156;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Quilava";
   ...
   */
   protected Quilava(String species, String name, int num, double ht, 
