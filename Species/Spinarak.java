...
*/
public class Spinarak extends Pokemon implements BugType, PoisonType {
   ...
   static final int POKEDEX_NUM = 167;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Spinarak";
   ...
   */
   protected Spinarak(String species, String name, int num, double ht, 
