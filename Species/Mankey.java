...
*/
public class Mankey extends Pokemon implements FightingType, NoneType {
   ...
   static final int POKEDEX_NUM = 56;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Mankey";
   ...
   */
   protected Mankey(String species, String name, int num, double ht, 
