...
*/
public class Elekid extends Pokemon implements ElectricType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 135;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 33;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 90;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 239;
   /** The species default height in meters. */
   static final double SPECIES_HT = 0.6;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 23.5;
   /** Species name. **/
   static final String SPECIES_NAME = "Elekid";
   ...
   */
   protected Elekid(String species, String name, int num, double ht, 
