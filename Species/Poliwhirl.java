...
/**
* Poliwhirl Pokémon object class.
* 
...
*/
public class Poliwhirl extends Pokemon implements WaterType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 130;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 39;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 130;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 61;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Poliwhirl";
   ...
   */
   protected Poliwhirl(String species, String name, int num, double ht, 
