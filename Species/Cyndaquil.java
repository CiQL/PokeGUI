...
/**
* Cyndaquil Pokémon object class.
* 
...
*/
public class Cyndaquil extends Pokemon implements FireType, NoneType {
   ...
   */
   protected Cyndaquil(String species, String name, int num, double ht, 
