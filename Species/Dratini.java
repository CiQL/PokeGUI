...
*/
public class Dratini extends Pokemon implements DragonType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 119;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 28;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 82;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 147;
   /** The species default height in meters. */
   static final double SPECIES_HT = 1.8;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 3.3;
   /** Species name. **/
   static final String SPECIES_NAME = "Dratini";
   ...
   */
   protected Dratini(String species, String name, int num, double ht, 
