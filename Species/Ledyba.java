...
*/
public class Ledyba extends Pokemon implements BugType, FlyingType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 72;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 43;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 80;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 165;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Ledyba";
   ...
   */
   protected Ledyba(String species, String name, int num, double ht, 
