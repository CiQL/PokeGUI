...
import Species.Types.GhostType;
import Species.Types.NoneType;
/**
* Misdreavus Pokémon object class.
* 
...
*/
public class Misdreavus extends Pokemon implements GhostType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 167;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 50;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 120;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 200;
   /** The species default height in meters. */
   static final double SPECIES_HT = 0.7;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 1.0;
   /** Species name. **/
   static final String SPECIES_NAME = "Misdreavus";
   ...
   */
   protected Misdreavus(String species, String name, int num, double ht, 
                     double wt, int baseAttackPwr, int baseDefensePwr, 
                     int baseStaminaPwr) {
      super(species, name, num, GHOST_COLOR, ht, wt, GHOST_TYPE, 
   ...
   */
   protected void chooseFastAttack() {
      chooseFastAttack(GHOST_FAST_ATTACKS, GHOST_FAST_ATK_POWER,
   ...
   */
   protected void chooseSpecialAttack() {
      chooseSpecialAttack(GHOST_SPECIAL_ATTACKS, GHOST_SPECIAL_ATK_POWER,
