...
*/
public class Paras extends Pokemon implements BugType, GrassType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 121;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 30;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 70;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 46;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Paras";
   ...
   */
   protected Paras(String species, String name, int num, double ht, 
