...
*/
public class Donphan extends Pokemon implements GroundType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 214;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 64;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 180;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 232;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Donphan";
   ...
   */
   protected Donphan(String species, String name, int num, double ht, 
