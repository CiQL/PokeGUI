...
*/
public class Gengar extends Pokemon implements GhostType, PoisonType {
   ...
   */
   protected Gengar(String species, String name, int num, double ht, 
