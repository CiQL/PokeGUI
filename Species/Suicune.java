...
*/
public class Suicune extends Pokemon implements WaterType, NoneType {
   ...
   */
   protected Suicune(String species, String name, int num, double ht, 
