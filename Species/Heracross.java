...
/**
* Heracross Pokémon object class.
* 
...
*/
public class Heracross extends Pokemon implements BugType, FightingType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 234;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 57;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 160;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 214;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Heracross";
   ...
   */
   protected Heracross(String species, String name, int num, double ht, 
