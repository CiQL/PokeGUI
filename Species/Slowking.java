...
*/
public class Slowking extends Pokemon implements WaterType, PsychicType {
   ...
   */
   protected Slowking(String species, String name, int num, double ht, 
