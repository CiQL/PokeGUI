...
*/
public class Porygon2 extends Pokemon implements NormalType, NoneType {
   ...
   */
   protected Porygon2(String species, String name, int num, double ht, 
