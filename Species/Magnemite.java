...
import Species.Types.ElectricType;
import Species.Types.SteelType;
/**
* Magnemite Pokémon object class.
* 
...
*/
public class Magnemite extends Pokemon implements ElectricType, SteelType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 165;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 38;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 50;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 81;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Magnemite";
   ...
   */
   protected Magnemite(String species, String name, int num, double ht, 
                     double wt, int baseAttackPwr, int baseDefensePwr, 
                     int baseStaminaPwr) {
      super(species, name, num, ELECTRIC_COLOR, ht, wt, ELECTRIC_TYPE, 
      STEEL_TYPE, baseAttackPwr, baseDefensePwr, baseStaminaPwr);
   ...
   */
   protected void chooseFastAttack() {
      chooseFastAttack(ELECTRIC_FAST_ATTACKS, ELECTRIC_FAST_ATK_POWER,
                       STEEL_FAST_ATTACKS, STEEL_FAST_ATK_POWER);
   }
   /** Fast attack chooser.
   ...
   */
   protected void chooseSpecialAttack() {
      chooseSpecialAttack(ELECTRIC_SPECIAL_ATTACKS, ELECTRIC_SPECIAL_ATK_POWER,
                          STEEL_SPECIAL_ATTACKS, STEEL_SPECIAL_ATK_POWER);
   }
   /** Special attack chooser.
   * Randomly picks an attack from given type attack arrays.
   * @param type1Attacks String array of attack names for type 1
