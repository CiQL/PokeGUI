...
*/
public class Raticate extends Pokemon implements NormalType, NoneType {
   ...
   */
   protected Raticate(String species, String name, int num, double ht, 
