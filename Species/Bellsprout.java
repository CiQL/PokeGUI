...
/**
* Bellsprout Pokémon object class.
* 
...
*/
public class Bellsprout extends Pokemon implements GrassType, PoisonType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 139;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 19;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 100;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 69;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Bellsprout";
   ...
   */
   protected Bellsprout(String species, String name, int num, double ht, 
