...
*/
public class Rhydon extends Pokemon implements GroundType, RockType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 222;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 62;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 210;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 112;
   /** The species default height in meters. */
   static final double SPECIES_HT = 1.9;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 120.0;
   /** Species name. **/
   static final String SPECIES_NAME = "Rhydon";
   ...
   */
   protected Rhydon(String species, String name, int num, double ht, 
                     double wt, int baseAttackPwr, int baseDefensePwr, 
                     int baseStaminaPwr) {
      super(species, name, num, GROUND_COLOR, ht, wt, GROUND_TYPE, 
      ROCK_TYPE, baseAttackPwr, baseDefensePwr, baseStaminaPwr);
   ...
   */
   protected void chooseFastAttack() {
      chooseFastAttack(GROUND_FAST_ATTACKS, GROUND_FAST_ATK_POWER,
                       ROCK_FAST_ATTACKS, ROCK_FAST_ATK_POWER);
   }
   /** Fast attack chooser.
   ...
   */
   protected void chooseSpecialAttack() {
      chooseSpecialAttack(GROUND_SPECIAL_ATTACKS, GROUND_SPECIAL_ATK_POWER,
                          ROCK_SPECIAL_ATTACKS, ROCK_SPECIAL_ATK_POWER);
   }
   /** Special attack chooser.
   * Randomly picks an attack from given type attack arrays.
   * @param type1Attacks String array of attack names for type 1
