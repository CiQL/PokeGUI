...
*/
public class Machamp extends Pokemon implements FightingType, NoneType {
   ...
   */
   protected Machamp(String species, String name, int num, double ht, 
