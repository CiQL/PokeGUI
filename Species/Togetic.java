...
*/
public class Togetic extends Pokemon implements FairyType, FlyingType {
   ...
   static final int POKEDEX_NUM = 176;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Togetic";
   ...
   */
   protected Togetic(String species, String name, int num, double ht, 
