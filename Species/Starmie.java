...
*/
public class Starmie extends Pokemon implements WaterType, PsychicType {
   ...
   */
   protected Starmie(String species, String name, int num, double ht, 
