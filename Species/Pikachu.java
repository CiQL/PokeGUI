...
*/
public class Pikachu extends Pokemon implements ElectricType, NoneType {
   ...
   static final int POKEDEX_NUM = 25;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Pikachu";
   ...
   */
   protected Pikachu(String species, String name, int num, double ht, 
