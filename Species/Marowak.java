...
*/
public class Marowak extends Pokemon implements GroundType, NoneType {
   ...
   */
   protected Marowak(String species, String name, int num, double ht, 
