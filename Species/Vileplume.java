...
/**
* Vileplume Pokémon object class.
* 
...
public class Vileplume extends Pokemon implements GrassType, PoisonType {
   ...
   */
   protected Vileplume(String species, String name, int num, double ht, 
