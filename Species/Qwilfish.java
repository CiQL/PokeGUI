...
public class Qwilfish extends Pokemon implements WaterType, PoisonType {
   ...
   */
   protected Qwilfish(String species, String name, int num, double ht, 
