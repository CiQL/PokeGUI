...
/**
* Hitmontop Pokémon object class.
* 
...
*/
public class Hitmontop extends Pokemon implements FightingType, NoneType {
   ...
   static final int POKEDEX_NUM = 237;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Hitmontop";
   ...
   */
   protected Hitmontop(String species, String name, int num, double ht, 
