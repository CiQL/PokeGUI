...
*/
public class Haunter extends Pokemon implements GhostType, PoisonType {
   ...
   static final int POKEDEX_NUM = 93;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Haunter";
   ...
   */
   protected Haunter(String species, String name, int num, double ht, 
