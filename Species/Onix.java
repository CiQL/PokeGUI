...
*/
public class Onix extends Pokemon implements RockType, GroundType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 85;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 86;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 70;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 95;
   /** The species default height in meters. */
   static final double SPECIES_HT = 8.8;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 210.0;
   /** Species name. **/
   static final String SPECIES_NAME = "Onix";
   ...
   */
   protected Onix(String species, String name, int num, double ht, 
