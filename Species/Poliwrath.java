...
/**
* Poliwrath Pokémon object class.
* 
...
public class Poliwrath extends Pokemon implements WaterType, FightingType {
   ...
   */
   protected Poliwrath(String species, String name, int num, double ht, 
                     double wt, int baseAttackPwr, int baseDefensePwr, 
                     int baseStaminaPwr) {
      super(species, name, num, WATER_COLOR, ht, wt, WATER_TYPE, 
      FIGHTING_TYPE, baseAttackPwr, baseDefensePwr, baseStaminaPwr);
   ...
   */
   protected void chooseFastAttack() {
      chooseFastAttack(WATER_FAST_ATTACKS, WATER_FAST_ATK_POWER,
                       FIGHTING_FAST_ATTACKS, FIGHTING_FAST_ATK_POWER);
   }
   /** Fast attack chooser.
   ...
   */
   protected void chooseSpecialAttack() {
      chooseSpecialAttack(WATER_SPECIAL_ATTACKS, WATER_SPECIAL_ATK_POWER,
                          FIGHTING_SPECIAL_ATTACKS, FIGHTING_SPECIAL_ATK_POWER);
   }
   /** Special attack chooser.
   * Randomly picks an attack from given type attack arrays.
   * @param type1Attacks String array of attack names for type 1
