...
/**
* Charmeleon Pokémon object class.
* 
...
*/
public class Charmeleon extends Pokemon implements FireType, NoneType {
   ...
   static final int POKEDEX_NUM = 5;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Charmeleon";
