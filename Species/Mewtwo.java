...
*/
public class Mewtwo extends Pokemon implements PsychicType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 300;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 55;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 193;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 150;
   /** The species default height in meters. */
   static final double SPECIES_HT = 2.0;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 122.0;
   /** Species name. **/
   static final String SPECIES_NAME = "Mewtwo";
   ...
   */
   protected Mewtwo(String species, String name, int num, double ht, 
