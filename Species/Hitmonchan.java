...
/**
* Hitmonchan Pokémon object class.
* 
...
*/
public class Hitmonchan extends Pokemon implements FightingType, NoneType {
   ...
   static final int POKEDEX_NUM = 107;
   /** The species default height in meters. */
   static final double SPECIES_HT = 1.4;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 50.2;
   /** Species name. **/
   static final String SPECIES_NAME = "Hitmonchan";
   ...
   */
   protected Hitmonchan(String species, String name, int num, double ht, 
