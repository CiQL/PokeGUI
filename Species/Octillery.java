...
/**
* Octillery Pokémon object class.
* 
...
*/
public class Octillery extends Pokemon implements WaterType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 197;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 42;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 150;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 224;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Octillery";
   ...
   */
   protected Octillery(String species, String name, int num, double ht, 
