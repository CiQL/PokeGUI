...
/**
* Dunsparce Pokémon object class.
* 
...
*/
public class Dunsparce extends Pokemon implements NormalType, NoneType {
   ...
   static final int POKEDEX_NUM = 206;
   /** The species default height in meters. */
   static final double SPECIES_HT = 1.5;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 14.0;
   /** Species name. **/
   static final String SPECIES_NAME = "Dunsparce";
   ...
   */
   protected Dunsparce(String species, String name, int num, double ht, 
