...
/**
* Weepinbell Pokémon object class.
* 
...
*/
public class Weepinbell extends Pokemon implements GrassType, PoisonType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 172;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 29;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 130;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 70;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Weepinbell";
   ...
   */
   protected Weepinbell(String species, String name, int num, double ht, 
