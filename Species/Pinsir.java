...
*/
public class Pinsir extends Pokemon implements BugType, NoneType {
   ...
   static final int POKEDEX_NUM = 127;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Pinsir";
   ...
   */
   protected Pinsir(String species, String name, int num, double ht, 
