...
*/
public class Politoed extends Pokemon implements WaterType, NoneType {
   ...
   */
   protected Politoed(String species, String name, int num, double ht, 
