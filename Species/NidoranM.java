...
*/
public class NidoranM extends Pokemon implements PoisonType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 105;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 23;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 92;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 32;
   /** The species default height in meters. */
   static final double SPECIES_HT = 0.5;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 9.0;
   /** Species name. **/
   static final String SPECIES_NAME = "Nidoran-M";
   ...
   */
   protected NidoranM(String species, String name, int num, double ht, 
