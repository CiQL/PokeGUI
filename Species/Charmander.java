...
/**
* Charmander Pokémon object class.
* 
...
*/
public class Charmander extends Pokemon implements FireType, NoneType {
   ...
   static final int POKEDEX_NUM = 4;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Charmander";
