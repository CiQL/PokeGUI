...
*/
public class Ariados extends Pokemon implements BugType, PoisonType {
   ...
   static final int POKEDEX_NUM = 168;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Ariados";
   ...
   */
   protected Ariados(String species, String name, int num, double ht, 
