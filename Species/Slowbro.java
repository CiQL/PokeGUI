...
*/
public class Slowbro extends Pokemon implements WaterType, PsychicType {
   ...
   */
   protected Slowbro(String species, String name, int num, double ht, 
