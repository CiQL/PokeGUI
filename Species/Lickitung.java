...
/**
* Lickitung Pokémon object class.
* 
...
*/
public class Lickitung extends Pokemon implements NormalType, NoneType {
   ...
   static final int POKEDEX_NUM = 108;
   /** The species default height in meters. */
   static final double SPECIES_HT = 1.2;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 65.5;
   /** Species name. **/
   static final String SPECIES_NAME = "Lickitung";
   ...
   */
   protected Lickitung(String species, String name, int num, double ht, 
