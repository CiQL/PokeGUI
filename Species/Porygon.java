...
*/
public class Porygon extends Pokemon implements NormalType, NoneType {
   ...
   */
   protected Porygon(String species, String name, int num, double ht, 
