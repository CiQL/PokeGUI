...
*/
public class Dugtrio extends Pokemon implements GroundType, NoneType {
   ...
   */
   protected Dugtrio(String species, String name, int num, double ht, 
