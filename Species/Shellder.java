...
*/
public class Shellder extends Pokemon implements WaterType, NoneType {
   ...
   static final int POKEDEX_NUM = 90;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Shellder";
   ...
   */
   protected Shellder(String species, String name, int num, double ht, 
