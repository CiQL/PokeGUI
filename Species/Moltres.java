...
*/
public class Moltres extends Pokemon implements FireType, FlyingType {
   ...
   static final int POKEDEX_NUM = 146;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Moltres";
   ...
   */
   protected Moltres(String species, String name, int num, double ht, 
