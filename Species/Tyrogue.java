...
public class Tyrogue extends Pokemon implements FightingType, NoneType {
   ...
   */
   protected Tyrogue(String species, String name, int num, double ht, 
