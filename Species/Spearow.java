...
*/
public class Spearow extends Pokemon implements NormalType, FlyingType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 112;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 18;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 80;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 21;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Spearow";
   ...
   */
   protected Spearow(String species, String name, int num, double ht, 
