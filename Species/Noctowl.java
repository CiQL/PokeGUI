...
*/
public class Noctowl extends Pokemon implements NormalType, FlyingType {
   ...
   */
   protected Noctowl(String species, String name, int num, double ht, 
