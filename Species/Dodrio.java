...
*/
public class Dodrio extends Pokemon implements NormalType, FlyingType {
   ...
   */
   protected Dodrio(String species, String name, int num, double ht, 
