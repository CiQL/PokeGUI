...
*/
public class Seaking extends Pokemon implements WaterType, NoneType {
   ...
   */
   protected Seaking(String species, String name, int num, double ht, 
