...
*/
public class Pichu extends Pokemon implements ElectricType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 77;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 19;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 40;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 172;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Pichu";
   ...
   */
   protected Pichu(String species, String name, int num, double ht, 
