...
*/
public class Kadabra extends Pokemon implements PsychicType, NoneType {
   ...
   */
   protected Kadabra(String species, String name, int num, double ht, 
