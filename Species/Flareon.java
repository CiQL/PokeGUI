...
*/
public class Flareon extends Pokemon implements FireType, NoneType {
   ...
   static final int POKEDEX_NUM = 136;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Flareon";
