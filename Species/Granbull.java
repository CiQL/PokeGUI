...
*/
public class Granbull extends Pokemon implements FairyType, NoneType {
   ...
   */
   protected Granbull(String species, String name, int num, double ht, 
