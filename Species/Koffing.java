...
*/
public class Koffing extends Pokemon implements PoisonType, NoneType {
   ...
   static final int POKEDEX_NUM = 109;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Koffing";
   ...
   */
   protected Koffing(String species, String name, int num, double ht, 
