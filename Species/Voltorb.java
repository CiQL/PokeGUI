...
*/
public class Voltorb extends Pokemon implements ElectricType, NoneType {
   ...
   */
   protected Voltorb(String species, String name, int num, double ht, 
