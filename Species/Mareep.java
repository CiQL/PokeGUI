...
*/
public class Mareep extends Pokemon implements ElectricType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 114;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 25;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 110;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 179;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Mareep";
   ...
   */
   protected Mareep(String species, String name, int num, double ht, 
