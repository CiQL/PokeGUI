...
/**
* Bellossom Pokémon object class.
* 
...
public class Bellossom extends Pokemon implements GrassType, NoneType {
   ...
   */
   protected Bellossom(String species, String name, int num, double ht, 
