...
*/
public class Zubat extends Pokemon implements PoisonType, FlyingType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 83;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 23;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 80;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 41;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Zubat";
   ...
   */
   protected Zubat(String species, String name, int num, double ht, 
