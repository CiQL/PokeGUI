...
*/
public class Hoothoot extends Pokemon implements NormalType, FlyingType {
   ...
   */
   protected Hoothoot(String species, String name, int num, double ht, 
