...
public class NidoranF extends Pokemon implements PoisonType, NoneType {
   ...
   */
   protected NidoranF(String species, String name, int num, double ht, 
