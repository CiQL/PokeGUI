...
*/
public class Caterpie extends Pokemon implements BugType, NoneType {
   ...
   */
   protected Caterpie(String species, String name, int num, double ht, 
