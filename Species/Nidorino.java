...
*/
public class Nidorino extends Pokemon implements PoisonType, NoneType {
   ...
   static final int POKEDEX_NUM = 33;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Nidorino";
   ...
   */
   protected Nidorino(String species, String name, int num, double ht, 
