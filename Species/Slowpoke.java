...
*/
public class Slowpoke extends Pokemon implements WaterType, PsychicType {
   ...
   */
   protected Slowpoke(String species, String name, int num, double ht, 
