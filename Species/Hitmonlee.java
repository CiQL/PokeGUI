...
/**
* Hitmonlee Pokémon object class.
* 
...
*/
public class Hitmonlee extends Pokemon implements FightingType, NoneType {
   ...
   static final int POKEDEX_NUM = 106;
   /** The species default height in meters. */
   static final double SPECIES_HT = 1.5;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 49.8;
   /** Species name. **/
   static final String SPECIES_NAME = "Hitmonlee";
   ...
   */
   protected Hitmonlee(String species, String name, int num, double ht, 
