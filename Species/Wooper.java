...
*/
public class Wooper extends Pokemon implements WaterType, GroundType {
   ...
   static final int POKEDEX_NUM = 194;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Wooper";
   ...
   */
   protected Wooper(String species, String name, int num, double ht, 
