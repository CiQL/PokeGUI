...
*/
public class Espeon extends Pokemon implements PsychicType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 261;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 58;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 130;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 196;
   /** The species default height in meters. */
   static final double SPECIES_HT = 0.9;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 26.5;
   /** Species name. **/
   static final String SPECIES_NAME = "Espeon";
   ...
   */
   protected Espeon(String species, String name, int num, double ht, 
