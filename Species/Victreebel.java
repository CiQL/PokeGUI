...
/**
* Victreebel Pokémon object class.
* 
...
*/
public class Victreebel extends Pokemon implements GrassType, PoisonType {
   ...
   static final int POKEDEX_NUM = 71;
   /** The species default height in meters. */
   static final double SPECIES_HT = 1.7;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 15.5;
   /** Species name. **/
   static final String SPECIES_NAME = "Victreebel";
   ...
   */
   protected Victreebel(String species, String name, int num, double ht, 
