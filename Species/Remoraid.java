...
*/
public class Remoraid extends Pokemon implements WaterType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 127;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 21;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 70;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 223;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Remoraid";
   ...
   */
   protected Remoraid(String species, String name, int num, double ht, 
