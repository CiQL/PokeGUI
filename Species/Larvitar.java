...
public class Larvitar extends Pokemon implements RockType, GroundType {
   ...
   */
   protected Larvitar(String species, String name, int num, double ht, 
