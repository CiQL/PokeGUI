...
*/
public class Weezing extends Pokemon implements PoisonType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 174;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 66;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 130;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 110;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Weezing";
   ...
   */
   protected Weezing(String species, String name, int num, double ht, 
