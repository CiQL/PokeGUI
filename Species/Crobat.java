...
*/
public class Crobat extends Pokemon implements PoisonType, FlyingType {
   ...
   */
   protected Crobat(String species, String name, int num, double ht, 
