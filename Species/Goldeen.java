...
*/
public class Goldeen extends Pokemon implements WaterType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 123;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 35;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 90;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 118;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Goldeen";
   ...
   */
   protected Goldeen(String species, String name, int num, double ht, 
