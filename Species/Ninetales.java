...
/**
* Ninetales Pokémon object class.
* 
...
*/
public class Ninetales extends Pokemon implements FireType, NoneType {
   ...
   */
   protected Ninetales(String species, String name, int num, double ht, 
