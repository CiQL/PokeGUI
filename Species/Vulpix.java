...
*/
public class Vulpix extends Pokemon implements FireType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 96;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 37;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 76;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 37;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Vulpix";
   ...
   */
   protected Vulpix(String species, String name, int num, double ht, 
