...
/**
* Igglybuff Pokémon object class.
* 
...
*/
public class Igglybuff extends Pokemon implements NormalType, FairyType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 69;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 10;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 180;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 174;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Igglybuff";
   ...
   */
   protected Igglybuff(String species, String name, int num, double ht, 
