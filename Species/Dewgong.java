...
*/
public class Dewgong extends Pokemon implements WaterType, IceType {
   ...
   static final int POKEDEX_NUM = 87;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Dewgong";
   ...
   */
   protected Dewgong(String species, String name, int num, double ht, 
