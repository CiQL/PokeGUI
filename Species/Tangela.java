...
*/
public class Tangela extends Pokemon implements GrassType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 183;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 62;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 130;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 114;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Tangela";
   ...
   */
   protected Tangela(String species, String name, int num, double ht, 
