...
*/
public class Gligar extends Pokemon implements GroundType, FlyingType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 143;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 61;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 130;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 207;
   /** The species default height in meters. */
   static final double SPECIES_HT = 1.1;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 64.8;
   /** Species name. **/
   static final String SPECIES_NAME = "Gligar";
   ...
   */
   protected Gligar(String species, String name, int num, double ht, 
