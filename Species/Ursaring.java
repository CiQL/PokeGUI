...
*/
public class Ursaring extends Pokemon implements NormalType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 236;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 43;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 180;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 217;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Ursaring";
   ...
   */
   protected Ursaring(String species, String name, int num, double ht, 
