...
*/
public class Machop extends Pokemon implements FightingType, NoneType {
   ...
   static final int POKEDEX_NUM = 66;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Machop";
   ...
   */
   protected Machop(String species, String name, int num, double ht, 
