...
*/
public class Pidgeot extends Pokemon implements NormalType, FlyingType {
   ...
   static final int BASE_STAMINA_POWER = 166;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 18;
   /** The species default height in meters. */
   static final double SPECIES_HT = 1.5;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 39.5;
   /** Species name. **/
   static final String SPECIES_NAME = "Pidgeot";
   ...
   */
   protected Pidgeot(String species, String name, int num, double ht, 
