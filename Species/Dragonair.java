...
/**
* Dragonair Pokémon object class.
* 
...
*/
public class Dragonair extends Pokemon implements DragonType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 163;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 41;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 122;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 148;
   /** The species default height in meters. */
   static final double SPECIES_HT = 4.0;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 16.5;
   /** Species name. **/
   static final String SPECIES_NAME = "Dragonair";
   ...
   */
   protected Dragonair(String species, String name, int num, double ht, 
