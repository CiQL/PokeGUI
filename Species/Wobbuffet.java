...
/**
* Wobbuffet Pokémon object class.
* 
...
*/
public class Wobbuffet extends Pokemon implements PsychicType, NoneType {
   ...
   static final int BASE_STAMINA_POWER = 380;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 202;
   /** The species default height in meters. */
   static final double SPECIES_HT = 1.3;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 28.5;
   /** Species name. **/
   static final String SPECIES_NAME = "Wobbuffet";
   ...
   */
   protected Wobbuffet(String species, String name, int num, double ht, 
