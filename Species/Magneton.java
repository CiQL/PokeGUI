...
*/
public class Magneton extends Pokemon implements ElectricType, SteelType {
   ...
   static final int BASE_STAMINA_POWER = 100;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 82;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Magneton";
   ...
   */
   protected Magneton(String species, String name, int num, double ht, 
