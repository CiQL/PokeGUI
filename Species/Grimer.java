...
*/
public class Grimer extends Pokemon implements PoisonType, NoneType {
   ...
   static final int POKEDEX_NUM = 88;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Grimer";
   ...
   */
   protected Grimer(String species, String name, int num, double ht, 
