...
*/
public class Stantler extends Pokemon implements NormalType, NoneType {
   ...
   */
   protected Stantler(String species, String name, int num, double ht, 
