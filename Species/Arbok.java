...
*/
public class Arbok extends Pokemon implements PoisonType, NoneType {
   ...
   static final int POKEDEX_NUM = 24;
   /** The species default height in meters. */
   static final double SPECIES_HT = 3.5;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 65.0;
   /** Species name. **/
   static final String SPECIES_NAME = "Arbok";
   ...
   */
   protected Arbok(String species, String name, int num, double ht, 
