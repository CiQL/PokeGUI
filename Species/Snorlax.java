...
*/
public class Snorlax extends Pokemon implements NormalType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 190;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 57;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 320;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 143;
   /** The species default height in meters. */
   static final double SPECIES_HT = 2.1;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 460.0;
   /** Species name. **/
   static final String SPECIES_NAME = "Snorlax";
   ...
   */
   protected Snorlax(String species, String name, int num, double ht, 
