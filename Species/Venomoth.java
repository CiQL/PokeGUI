...
*/
public class Venomoth extends Pokemon implements BugType, PoisonType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 179;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 45;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 140;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 49;
   /** The species default height in meters. */
   static final double SPECIES_HT = 1.5;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 12.5;
   /** Species name. **/
   static final String SPECIES_NAME = "Venomoth";
   ...
   */
   protected Venomoth(String species, String name, int num, double ht, 
