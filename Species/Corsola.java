...
*/
public class Corsola extends Pokemon implements WaterType, RockType {
   ...
   static final int POKEDEX_NUM = 222;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Corsola";
   ...
   */
   protected Corsola(String species, String name, int num, double ht, 
