...
*/
public class Ditto extends Pokemon implements NormalType, NoneType {
   ...
   static final int POKEDEX_NUM = 132;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Ditto";
   ...
   */
   protected Ditto(String species, String name, int num, double ht, 
