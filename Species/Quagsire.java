...
*/
public class Quagsire extends Pokemon implements WaterType, GroundType {
   ...
   static final int POKEDEX_NUM = 195;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Quagsire";
   ...
   */
   protected Quagsire(String species, String name, int num, double ht, 
