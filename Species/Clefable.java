...
*/
public class Clefable extends Pokemon implements FairyType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 178;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 51;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 190;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 36;
   /** The species default height in meters. */
   static final double SPECIES_HT = 1.3;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 40.0;
   /** Species name. **/
   static final String SPECIES_NAME = "Clefable";
   ...
   */
   protected Clefable(String species, String name, int num, double ht, 
