...
*/
public class Sentret extends Pokemon implements NormalType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 79;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 23;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 70;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 161;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Sentret";
   ...
   */
   protected Sentret(String species, String name, int num, double ht, 
