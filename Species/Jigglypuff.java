...
/**
* Jigglypuff Pokémon object class.
* 
...
*/
public class Jigglypuff extends Pokemon implements NormalType, FairyType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 80;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 13;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 230;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 39;
   /** The species default height in meters. */
   static final double SPECIES_HT = 0.5;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 5.5;
   /** Species name. **/
   static final String SPECIES_NAME = "Jigglypuff";
   ...
   */
   protected Jigglypuff(String species, String name, int num, double ht, 
