...
*/
public class Lapras extends Pokemon implements WaterType, IceType {
   ...
   static final int POKEDEX_NUM = 131;
   /** The species default height in meters. */
   static final double SPECIES_HT = 2.5;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 220.0;
   /** Species name. **/
   static final String SPECIES_NAME = "Lapras";
   ...
   */
   protected Lapras(String species, String name, int num, double ht, 
