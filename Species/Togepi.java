...
*/
public class Togepi extends Pokemon implements FairyType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 67;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 35;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 70;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 175;
   /** The species default height in meters. */
   static final double SPECIES_HT = 0.3;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 1.5;
   /** Species name. **/
   static final String SPECIES_NAME = "Togepi";
   ...
   */
   protected Togepi(String species, String name, int num, double ht, 
