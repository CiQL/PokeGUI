...
/**
* Electrode Pokémon object class.
* 
...
*/
public class Electrode extends Pokemon implements ElectricType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 173;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 54;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 120;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 101;
   /** The species default height in meters. */
   static final double SPECIES_HT = 1.2;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 66.6;
   /** Species name. **/
   static final String SPECIES_NAME = "Electrode";
   ...
   */
   protected Electrode(String species, String name, int num, double ht, 
