...
/**
* Teddiursa Pokémon object class.
* 
...
public class Teddiursa extends Pokemon implements NormalType, NoneType {
   ...
   */
   protected Teddiursa(String species, String name, int num, double ht, 
