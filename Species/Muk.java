...
*/
public class Muk extends Pokemon implements PoisonType, NoneType {
   ...
   static final int POKEDEX_NUM = 89;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Muk";
   ...
   */
   protected Muk(String species, String name, int num, double ht, 
