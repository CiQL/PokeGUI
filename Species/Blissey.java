...
*/
public class Blissey extends Pokemon implements NormalType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 129;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 69;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 510;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 242;
   /** The species default height in meters. */
   static final double SPECIES_HT = 1.5;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 46.8;
   /** Species name. **/
   static final String SPECIES_NAME = "Blissey";
   ...
   */
   protected Blissey(String species, String name, int num, double ht, 
