...
/**
* Farfetchd Pokémon object class.
* 
...
*/
public class Farfetchd extends Pokemon implements NormalType, FlyingType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 124;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 35;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 104;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 83;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Farfetchd";
   ...
   */
   protected Farfetchd(String species, String name, int num, double ht, 
