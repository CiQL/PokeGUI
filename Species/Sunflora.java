...
*/
public class Sunflora extends Pokemon implements GrassType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 185;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 44;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 150;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 192;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Sunflora";
   ...
   */
   protected Sunflora(String species, String name, int num, double ht, 
