...
/**
* Growlithe Pokémon object class.
* 
...
*/
public class Growlithe extends Pokemon implements FireType, NoneType {
   ...
   */
   protected Growlithe(String species, String name, int num, double ht, 
