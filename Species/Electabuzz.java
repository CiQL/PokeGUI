...
/**
* Electabuzz Pokémon object class.
* 
...
*/
public class Electabuzz extends Pokemon implements ElectricType, NoneType {
   ...
   static final int POKEDEX_NUM = 125;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Electabuzz";
   ...
   */
   protected Electabuzz(String species, String name, int num, double ht, 
