...
*/
public class Cubone extends Pokemon implements GroundType, NoneType {
   ...
   static final int POKEDEX_NUM = 104;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Cubone";
   ...
   */
   protected Cubone(String species, String name, int num, double ht, 
