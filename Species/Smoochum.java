...
import Species.Types.IceType;
import Species.Types.PsychicType;
/**
* Smoochum Pokémon object class.
* 
...
*/
public class Smoochum extends Pokemon implements IceType, PsychicType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 153;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 35;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 90;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 238;
   /** The species default height in meters. */
   static final double SPECIES_HT = 0.4;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 6.0;
   /** Species name. **/
   static final String SPECIES_NAME = "Smoochum";
   ...
   */
   protected Smoochum(String species, String name, int num, double ht, 
                     double wt, int baseAttackPwr, int baseDefensePwr, 
                     int baseStaminaPwr) {
      super(species, name, num, ICE_COLOR, ht, wt, ICE_TYPE, 
      PSYCHIC_TYPE, baseAttackPwr, baseDefensePwr, baseStaminaPwr);
   ...
   */
   protected void chooseFastAttack() {
      chooseFastAttack(ICE_FAST_ATTACKS, ICE_FAST_ATK_POWER,
                       PSYCHIC_FAST_ATTACKS, PSYCHIC_FAST_ATK_POWER);
   }
   /** Fast attack chooser.
   ...
   */
   protected void chooseSpecialAttack() {
      chooseSpecialAttack(ICE_SPECIAL_ATTACKS, ICE_SPECIAL_ATK_POWER,
                          PSYCHIC_SPECIAL_ATTACKS, PSYCHIC_SPECIAL_ATK_POWER);
   }
   /** Special attack chooser.
   * Randomly picks an attack from given type attack arrays.
   * @param type1Attacks String array of attack names for type 1
