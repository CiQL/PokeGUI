...
/**
* Azumarill Pokémon object class.
* 
...
*/
public class Azumarill extends Pokemon implements WaterType, FairyType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 112;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 46;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 200;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 184;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Azumarill";
   ...
   */
   protected Azumarill(String species, String name, int num, double ht, 
