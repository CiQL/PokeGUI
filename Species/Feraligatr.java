...
/**
* Feraligatr Pokémon object class.
* 
...
*/
public class Feraligatr extends Pokemon implements WaterType, NoneType {
   ...
   static final int POKEDEX_NUM = 160;
   /** The species default height in meters. */
   static final double SPECIES_HT = 2.3;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 88.8;
   /** Species name. **/
   static final String SPECIES_NAME = "Feraligatr";
   ...
   */
   protected Feraligatr(String species, String name, int num, double ht, 
