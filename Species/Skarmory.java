...
*/
public class Skarmory extends Pokemon implements SteelType, FlyingType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 148;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 78;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 130;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 227;
   /** The species default height in meters. */
   static final double SPECIES_HT = 1.7;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 50.5;
   /** Species name. **/
   static final String SPECIES_NAME = "Skarmory";
   ...
   */
   protected Skarmory(String species, String name, int num, double ht, 
                     double wt, int baseAttackPwr, int baseDefensePwr, 
                     int baseStaminaPwr) {
      super(species, name, num, STEEL_COLOR, ht, wt, STEEL_TYPE, 
   ...
   */
   protected void chooseFastAttack() {
      chooseFastAttack(STEEL_FAST_ATTACKS, STEEL_FAST_ATK_POWER,
   ...
   */
   protected void chooseSpecialAttack() {
      chooseSpecialAttack(STEEL_SPECIAL_ATTACKS, STEEL_SPECIAL_ATK_POWER,
