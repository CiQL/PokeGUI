...
*/
public class Primeape extends Pokemon implements FightingType, NoneType {
   ...
   static final int POKEDEX_NUM = 57;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Primeape";
   ...
   */
   protected Primeape(String species, String name, int num, double ht, 
