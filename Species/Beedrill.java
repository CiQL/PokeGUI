...
*/
public class Beedrill extends Pokemon implements BugType, PoisonType {
   ...
   static final int POKEDEX_NUM = 15;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Beedrill";
   ...
   */
   protected Beedrill(String species, String name, int num, double ht, 
