...
/**
* Chikorita Pokémon object class.
* 
...
*/
public class Chikorita extends Pokemon implements GrassType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 92;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 37;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 90;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 152;
   /** The species default height in meters. */
   static final double SPECIES_HT = 0.9;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 6.4;
   /** Species name. **/
   static final String SPECIES_NAME = "Chikorita";
   ...
   */
   protected Chikorita(String species, String name, int num, double ht, 
