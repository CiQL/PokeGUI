...
/**
* Forretress Pokémon object class.
* 
...
*/
public class Forretress extends Pokemon implements BugType, SteelType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 161;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 73;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 150;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 205;
   /** The species default height in meters. */
   static final double SPECIES_HT = 1.2;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 125.8;
   /** Species name. **/
   static final String SPECIES_NAME = "Forretress";
   ...
   */
   protected Forretress(String species, String name, int num, double ht, 
