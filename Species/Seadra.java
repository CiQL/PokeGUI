...
*/
public class Seadra extends Pokemon implements WaterType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 187;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 55;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 110;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 117;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Seadra";
   ...
   */
   protected Seadra(String species, String name, int num, double ht, 
