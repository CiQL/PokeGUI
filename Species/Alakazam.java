...
public class Alakazam extends Pokemon implements PsychicType, NoneType {
   ...
   */
   protected Alakazam(String species, String name, int num, double ht, 
