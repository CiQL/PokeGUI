...
*/
public class Diglett extends Pokemon implements GroundType, NoneType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 109;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 26;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 20;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 50;
   /** The species default height in meters. */
   static final double SPECIES_HT = 0.2;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 0.8;
   /** Species name. **/
   static final String SPECIES_NAME = "Diglett";
   ...
   */
   protected Diglett(String species, String name, int num, double ht, 
