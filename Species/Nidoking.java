...
*/
public class Nidoking extends Pokemon implements PoisonType, GroundType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 204;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 47;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 162;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 34;
   /** The species default height in meters. */
   static final double SPECIES_HT = 1.4;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 62.0;
   /** Species name. **/
   static final String SPECIES_NAME = "Nidoking";
   ...
   */
   protected Nidoking(String species, String name, int num, double ht, 
