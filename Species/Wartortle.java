...
/**
* Wartortle Pokémon object class.
* 
...
*/
public class Wartortle extends Pokemon implements WaterType, NoneType {
   ...
   static final int POKEDEX_NUM = 8;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Wartortle";
