...
*/
public class Venonat extends Pokemon implements BugType, PoisonType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 100;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 31;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 120;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 48;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Venonat";
   ...
   */
   protected Venonat(String species, String name, int num, double ht, 
