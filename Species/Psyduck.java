...
*/
public class Psyduck extends Pokemon implements WaterType, NoneType {
   ...
   */
   protected Psyduck(String species, String name, int num, double ht, 
