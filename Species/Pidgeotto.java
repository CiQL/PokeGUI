...
/**
* Pidgeotto Pokémon object class.
* 
...
*/
public class Pidgeotto extends Pokemon implements NormalType, FlyingType {
   ...
   static final int BASE_STAMINA_POWER = 126;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 17;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Pidgeotto";
   ...
   */
   protected Pidgeotto(String species, String name, int num, double ht, 
