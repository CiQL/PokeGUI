...
public class Nidorina extends Pokemon implements PoisonType, NoneType {
   ...
   */
   protected Nidorina(String species, String name, int num, double ht, 
