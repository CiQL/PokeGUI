...
*/
public class Totodile extends Pokemon implements WaterType, NoneType {
   ...
   */
   protected Totodile(String species, String name, int num, double ht, 
