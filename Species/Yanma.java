...
*/
public class Yanma extends Pokemon implements BugType, FlyingType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 154;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 28;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 130;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 193;
   ...
   /** Species name. **/
   static final String SPECIES_NAME = "Yanma";
   ...
   */
   protected Yanma(String species, String name, int num, double ht, 
