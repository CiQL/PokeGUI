...
/**
* Girafarig Pokémon object class.
* 
...
*/
public class Girafarig extends Pokemon implements NormalType, PsychicType {

   /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 182;
   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 40;
   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 140;
   /** The species Pokedex number. */
   static final int POKEDEX_NUM = 203;
   /** The species default height in meters. */
   static final double SPECIES_HT = 1.5;
   /** The species default weight in kilograms. */
   static final double SPECIES_WT = 41.5;
   /** Species name. **/
   static final String SPECIES_NAME = "Girafarig";
   ...
   */
   protected Girafarig(String species, String name, int num, double ht, 
